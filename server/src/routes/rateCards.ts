...
const ALLOWED_IMPORT_HEADERS = "Content-Type, Authorization, X-Requested-With";
const ALLOWED_IMPORT_METHODS = "POST, OPTIONS";

function applyImportCors(req: Request, res: Response) {
  ...
  res.header("Access-Control-Allow-Headers", ALLOWED_IMPORT_HEADERS);
  res.header("Access-Control-Allow-Methods", ALLOWED_IMPORT_METHODS);
}

const handleImportPreflight = (req: Request, res: Response) => {
