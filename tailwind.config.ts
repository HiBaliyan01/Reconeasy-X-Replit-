...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        "page-title": "var(--re-font-page-title)",
        heading: "var(--re-font-heading)",
        body: "var(--re-font-body)",
        meta: "var(--re-font-meta)",
        label: "var(--re-font-label)",
        nav: "var(--re-font-nav)",
        "nav-desc": "var(--re-font-nav-desc)",
      },
      height: {
        btn: "var(--re-height-btn)",
        "btn-sm": "var(--re-height-btn-sm)",
        input: "var(--re-height-input)",
        "table-row": "var(--re-height-table-row)",
      },
      size: {
        "icon-nav": "var(--re-icon-nav)",
        "icon-action": "var(--re-icon-action)",
        "icon-sm": "var(--re-icon-sm)",
      },
    },
  },
  plugins: [],
