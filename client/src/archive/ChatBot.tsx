// ARCHIVED — replaced by EnhancedChatBot
// Kept for reference: simple chat UI pattern
  ...
  return (
    <>
      ...
      <button
        ...
        aria-label="Open ReconEasy assistant"
        className={`fixed bottom-8 right-6 h-14 rounded-full bg-gradient-to-r from-teal-500 to-teal-600 px-4 text-white shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-2 z-50 ${
          isOpen ? 'scale-0' : 'scale-100 hover:scale-105'
        }`}
      >
        <MessageCircle className="w-6 h-6" />
        <span className="hidden text-sm font-medium sm:inline">Ask ReconEasy</span>
      </button>
