...
const HEADER_ALIASES: Record<string, string[]> = {
  ...
  "tech fee type": ["tech fee mode", "tech fee kind"],
  "tech fee value": ["tech fee", "technology fee", "platform fee"],
  gst: ["gst tax"],
...
const EXPECTED_HEADERS = [
  ...
  { display: "Tech Fee Type", key: "tech fee type" },
  { display: "Tech Fee Value", key: "tech fee value" },
  { display: "Collection Fee %", key: "collection fee %" },
  { display: "Discount / Promo Contribution %", key: "discount promo percent" },
  { display: "GST %", key: "gst" },
  { display: "TCS %", key: "tcs" },
